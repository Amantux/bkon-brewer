...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-480%20passing-3c8f54.svg" alt="480 tests passing">
...
> **Status:** built and unit-tested (480 assertions), **not yet hardware-tested**.
...
```bash
./tests/run_all.sh          # 480 assertions, no dependencies
```
