...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-392%20passing-3c8f54.svg" alt="392 tests passing">
...
> **Status:** built and unit-tested (392 assertions), **not yet hardware-tested**.
...
```bash
./tests/run_all.sh          # 392 assertions, no dependencies
```
