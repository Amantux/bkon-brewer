...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-489%20passing-3c8f54.svg" alt="489 tests passing">
...
> **Status:** built and unit-tested (489 assertions), **not yet hardware-tested**.
...
```bash
./tests/run_all.sh          # 489 assertions, no dependencies
```
