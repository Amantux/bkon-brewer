...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-444%20passing-3c8f54.svg" alt="444 tests passing">
...
> **Status:** built and unit-tested (444 assertions), **not yet hardware-tested**.
...
```bash
./tests/run_all.sh          # 444 assertions, no dependencies
```
