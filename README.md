...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-404%20passing-3c8f54.svg" alt="404 tests passing">
...
> **Status:** built and unit-tested (404 assertions), **not yet hardware-tested**.
...
```bash
./tests/run_all.sh          # 404 assertions, no dependencies
```
