...
check("fill pause 10 -> 15", val(c.steps, R.StepType.FILL, "dl"), 15)
...
check("pause shortened 10 -> 5", val(c.steps, R.StepType.FILL, "dl"), 5)
...
check("steep down 10 -> 5", val(c.steps, R.StepType.FILL, "dl"), 5)
